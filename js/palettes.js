...
const colorPalettes = [
  ...
  // Palette 10: Dark Navy/Deep Blue with Yellow accents - Terminal Velocity (changed from red/pink to dark with yellow)
  {
    name: "Terminal Velocity",
    skybox: {
      baseColor1: { x: 0.0, y: 0.0, z: 0.06 },
      baseColor2: { x: 0.0, y: 0.0, z: 0.12 },
      pulseTint1: { x: 0.0, y: 0.0, z: 0.7 },
      pulseTint2: { x: 0.2, y: 0.3, z: 1.0 },
      toneShift: { x: 0.8, y: 1.0, z: 1.8 },
    },
    ring1: { color: 0x001144, emissive: 0x002266 },
    ring2: { color: 0xffcc00, emissive: 0xffcc00 },
    ring3: { color: 0x002244, emissive: 0x003366 },
    ring4: { color: 0x000033, emissive: 0x001144 },
    ring5: { color: 0xffaa00, emissive: 0xffaa00 },
    ring6: { color: 0x003355, emissive: 0x004466 },
    ring7: { color: 0xff9900, emissive: 0xff9900 },
    ring8: { color: 0x001122, emissive: 0x002233 },
    ring9: { color: 0xffff44, emissive: 0xffff44 },
    inner: { color: 0x002244, emissive: 0x003366 },
    outline: { visible: "#001144", hidden: "#ffcc00" },
  },
